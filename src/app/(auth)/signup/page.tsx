...
export default function SignupPage() {
  ...
  return (
    <AuthPanel illustrationSrc="https://www.figma.com/api/mcp/asset/647ba2fd-d304-4281-b2b8-924eb318643b">
      <div className="mb-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-5">
          <FieldInput label="Full name" id="fullName" name="fullName" placeholder="Start typing…" required autoComplete="name" />
          <FieldInput label="Email" id="email" name="email" type="email" placeholder="Start typing…" required autoComplete="email" />
          <FieldInput label="Password" id="password" name="password" type="password" placeholder="Start typing…" required autoComplete="new-password" />
        </div>
